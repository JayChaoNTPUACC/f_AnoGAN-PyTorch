...
def main():
    args = {
        "inputs_dir": "./data/normal",  # Path to input image directory.
        "output_dir": "./data/normal_sub",  # Path to generator image directory.
        "crop_size": 64,  # Crop image size from raw image.
